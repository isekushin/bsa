...
- SOAP: Basic Concepts;
- XML, XSD, WSDL;
- Development approaches: code-first or contract-first.
...
Instead of Microsoft Office you can use its analogues, for example LibreOffice Writer and LibreOffice Calc or Google Docs and Google Sheets.
